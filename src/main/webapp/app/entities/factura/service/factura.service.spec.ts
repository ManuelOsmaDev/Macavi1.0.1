...
describe('Factura Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      descripcion: 'AAAAAAA',
      fechaFact: currentDate,
      fechaVenc: currentDate,
      tipoPago: 'AAAAAAA',
      totalFactura: 0,
    };
  });
  ...
  describe('Service methods', () => {
    it('should find an element', () => {
      const returnedFromService = Object.assign(
        {
          fechaFact: currentDate.format(DATE_TIME_FORMAT),
          fechaVenc: currentDate.format(DATE_TIME_FORMAT),
        },
        elemDefault
      );
    ...
    describe('addFacturaToCollectionIfMissing', () => {
      ...
      it('should add only unique Factura to an array', () => {
        const facturaArray: IFactura[] = [{ id: 123 }, { id: 456 }, { id: 951 }];
