        ...
        Optional<Producto> result = productoRepository
            ...
            .map(existingProducto -> {
                if (producto.getCantidadProducto() != null) {
                    existingProducto.setCantidadProducto(producto.getCantidadProducto());
                }
                if (producto.getDescripcionProdcuto() != null) {
                    existingProducto.setDescripcionProdcuto(producto.getDescripcionProdcuto());
                }
                if (producto.getEstilo() != null) {
                    existingProducto.setEstilo(producto.getEstilo());
                }
                ...
                if (producto.getPorcentajeIva() != null) {
                    existingProducto.setPorcentajeIva(producto.getPorcentajeIva());
                }
