...
/**
 * REST controller for managing {@link com.macavi.domain.Usuario}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Usuario> result = usuarioRepository
            ...
            .map(existingUsuario -> {
                ...
                if (usuario.getLoginUsuario() != null) {
                    existingUsuario.setLoginUsuario(usuario.getLoginUsuario());
                }
                if (usuario.getNombre() != null) {
                    existingUsuario.setNombre(usuario.getNombre());
                }
                if (usuario.getTipoDni() != null) {
                    existingUsuario.setTipoDni(usuario.getTipoDni());
                }
