...
class ClienteResourceIT {
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente().direcion(DEFAULT_DIRECION).telefono(DEFAULT_TELEFONO);
        return cliente;
    }
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        Cliente cliente = new Cliente().direcion(UPDATED_DIRECION).telefono(UPDATED_TELEFONO);
        return cliente;
    }
    ...
    @Test
    @Transactional
    void checkDirecionIsRequired() throws Exception {
    ...
    void putNewCliente() throws Exception {
        ...
        updatedCliente.direcion(UPDATED_DIRECION).telefono(UPDATED_TELEFONO);
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.direcion(UPDATED_DIRECION).telefono(UPDATED_TELEFONO);
