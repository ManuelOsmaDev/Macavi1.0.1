...
class RolResourceIT {
    ...
    public static Rol createEntity(EntityManager em) {
        Rol rol = new Rol().nombreRol(DEFAULT_NOMBRE_ROL);
        return rol;
    }
    ...
    public static Rol createUpdatedEntity(EntityManager em) {
        Rol rol = new Rol().nombreRol(UPDATED_NOMBRE_ROL);
        return rol;
    }
    ...
    void createRol() throws Exception {
        ...
        assertThat(testRol.getNombreRol()).isEqualTo(DEFAULT_NOMBRE_ROL);
    }
    ...
    @Test
    @Transactional
    void checkNombreRolIsRequired() throws Exception {
    ...
    void putNewRol() throws Exception {
        ...
        updatedRol.nombreRol(UPDATED_NOMBRE_ROL);
        ...
        Rol testRol = rolList.get(rolList.size() - 1);
        assertThat(testRol.getNombreRol()).isEqualTo(UPDATED_NOMBRE_ROL);
    }
    ...
    void partialUpdateRolWithPatch() throws Exception {
        ...
        partialUpdatedRol.nombreRol(UPDATED_NOMBRE_ROL);
