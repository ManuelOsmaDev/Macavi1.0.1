...
class TipoDniResourceIT {
    ...
    public static TipoDni createEntity(EntityManager em) {
        TipoDni tipoDni = new TipoDni().nombreDni(DEFAULT_NOMBRE_DNI);
        return tipoDni;
    }
    ...
    public static TipoDni createUpdatedEntity(EntityManager em) {
        TipoDni tipoDni = new TipoDni().nombreDni(UPDATED_NOMBRE_DNI);
        return tipoDni;
    }
    ...
    void createTipoDni() throws Exception {
        ...
        // Create the TipoDni
        restTipoDniMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(tipoDni)))
    ...
    void putNewTipoDni() throws Exception {
        ...
        updatedTipoDni.nombreDni(UPDATED_NOMBRE_DNI);

        restTipoDniMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedTipoDni.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedTipoDni))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingTipoDni() throws Exception {
        ...
        restTipoDniMockMvc
            .perform(
                put(ENTITY_API_URL_ID, tipoDni.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(tipoDni))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamTipoDni() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTipoDniMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(tipoDni)))
    ...
    void partialUpdateTipoDniWithPatch() throws Exception {
        ...
        partialUpdatedTipoDni.nombreDni(UPDATED_NOMBRE_DNI);
    ...
    void patchNonExistingTipoDni() throws Exception {
        ...
        restTipoDniMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, tipoDni.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(tipoDni))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamTipoDni() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTipoDniMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(tipoDni)))
            .andExpect(status().isMethodNotAllowed());
