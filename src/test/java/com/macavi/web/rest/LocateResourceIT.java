...
class LocateResourceIT {
    ...
    void createLocate() throws Exception {
        ...
        // Create the Locate
        restLocateMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(locate)))
    ...
    void putNewLocate() throws Exception {
        ...
        restLocateMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedLocate.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedLocate))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingLocate() throws Exception {
        ...
        restLocateMockMvc
            .perform(
                put(ENTITY_API_URL_ID, locate.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(locate))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamLocate() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restLocateMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(locate)))
    ...
    void patchNonExistingLocate() throws Exception {
        ...
        restLocateMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, locate.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(locate))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamLocate() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restLocateMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(locate)))
            .andExpect(status().isMethodNotAllowed());
