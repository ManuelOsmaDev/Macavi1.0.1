...
import com.macavi.domain.Usuario;
import com.macavi.repository.UsuarioRepository;
...
class UsuarioResourceIT {
    ...
    private static final String DEFAULT_TIPO_DNI = "AAAAAAAAAA";
    private static final String UPDATED_TIPO_DNI = "BBBBBBBBBB";
    ...
    void createUsuario() throws Exception {
        ...
        assertThat(testUsuario.getTipoDni()).isEqualTo(DEFAULT_TIPO_DNI);
    ...
    @Test
    @Transactional
    void checkLoginUsuarioIsRequired() throws Exception {
        int databaseSizeBeforeTest = usuarioRepository.findAll().size();
        // set the field null
        usuario.setLoginUsuario(null);
    ...
    @Test
    @Transactional
    void checkTipoDniIsRequired() throws Exception {
        int databaseSizeBeforeTest = usuarioRepository.findAll().size();
        // set the field null
    ...
    void getAllUsuarios() throws Exception {
        ...
        restUsuarioMockMvc
            ...
            .andExpect(jsonPath("$.[*].tipoDni").value(hasItem(DEFAULT_TIPO_DNI)))
    ...
    void getUsuario() throws Exception {
        ...
        restUsuarioMockMvc
            ...
            .andExpect(jsonPath("$.tipoDni").value(DEFAULT_TIPO_DNI))
    ...
    void putNewUsuario() throws Exception {
        ...
        assertThat(testUsuario.getTipoDni()).isEqualTo(UPDATED_TIPO_DNI);
    ...
    void partialUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.email(UPDATED_EMAIL).loginUsuario(UPDATED_LOGIN_USUARIO).password(UPDATED_PASSWORD);
